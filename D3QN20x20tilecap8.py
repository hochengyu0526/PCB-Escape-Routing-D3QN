...
def get_best_candidate_indices_circular(pin_r, pin_c, perimeter_list, cursor, usage_map, cap_per_tile, rows, cols):
    ...
    candidates = []
    w_phys_dist = 1.0; w_gap_dist = 1.0   
...
def run_integrated_demo():
    ...
    MODEL_PATH = "pcb_d3qn_20x20_tilecap8_ver2.pth" 
    BEST_MODEL_PATH = "pcb_d3qn_best_ver2.pth" # 最佳模型的檔名
    # --- [4090 優化參數] ---
    ...
    raw_pins = [
        ...
        (16, 17.5, 15.5, 16), (17, 18.5, 15.5, 17), (18, 19.5, 15.5, 18),
        # --- Bottom Area ---
        (19, 13.5, 11.5, 19), (20, 19.5, 16.5, 20), (21, 18.5, 18.5, 21), (22, 18.5, 17.5, 22),
        (23, 19.5, 18.5, 23), (24, 19.5, 17.5, 24), (25, 18.5, 19.5, 25), (26, 19.5, 19.5, 26), 
        (27, 17.5, 19.5, 27), (28, 16.5, 17.5, 28), (29, 16.5, 19.5, 29), (30, 15.5, 16.5, 30),
        (31, 15.5, 18.5, 31), (32, 15.5, 17.5, 32), (33, 14.5, 14.5, 33), (34, 14.5, 16.5, 34),
        (35, 14.5, 17.5, 35), (36, 14.5, 18.5, 36), (37, 13.5, 14.5, 37), (38, 13.5, 15.5, 38),
        (39, 13.5, 18.5, 39), (40, 13.5, 19.5, 40), (41, 12.5, 16.5, 41), (42, 12.5, 17.5, 42),
        (43, 12.5, 19.5, 43), (44, 11.5, 14.5, 44), (45, 11.5, 16.5, 45), (46, 11.5, 17.5, 46),
        (47, 11.5, 18.5, 47), (48, 11.5, 19.5, 48), (49, 7.5, 11.5, 49),  (50, 10.5, 15.5, 50),
        (51, 10.5, 16.5, 51), (52, 9.5, 17.5, 52),  (53, 9.5, 18.5, 53),  (54, 9.5, 19.5, 54),
        (55, 8.5, 14.5, 55),  (56, 8.5, 15.5, 56),  (57, 8.5, 18.5, 57),  (58, 8.5, 19.5, 58),
        (59, 7.5, 14.5, 59),  (60, 10.5, 13.5, 60), (61, 7.5, 19.5, 61),  (62, 6.5, 17.5, 62),
        (63, 6.5, 18.5, 63),  (64, 6.5, 19.5, 64),  (65, 5.5, 15.5, 65),  (66, 5.5, 18.5, 66),
        (67, 5.5, 16.5, 67),  (68, 5.5, 19.5, 68),  (69, 4.5, 18.5, 69),
        # --- Top Right Area ---
        (70, 4.5, 17.5, 70),  (71, 4.5, 16.5, 71),  (72, 2.5, 17.5, 72),  (73, 2.5, 18.5, 73),
        (74, 2.5, 19.5, 74),  (75, 1.5, 19.5, 75),  (76, 0.5, 19.5, 76),  (77, 0.5, 18.5, 77),
        (78, 1.5, 17.5, 78),  (79, 2.5, 16.5, 79),  (80, 1.5, 16.5, 80),  (81, 0.5, 16.5, 81),
        (82, 0.5, 15.5, 82),  (83, 3.5, 14.5, 83),  (84, 4.5, 14.5, 84),  (85, 1.5, 14.5, 85),
        (86, 0.5, 14.5, 86),  (87, 8.5, 9.5, 87),   (88, 1.5, 13.5, 88),  (89, 0.5, 13.5, 89),
        (90, 6.5, 12.5, 90),  (91, 4.5, 12.5, 91),  (92, 3.5, 12.5, 92),  (93, 2.5, 12.5, 93),
        (94, 1.5, 12.5, 94),  (95, 5.5, 11.5, 95),  (96, 0.5, 11.5, 96),  (97, 3.5, 10.5, 97),
        (98, 2.5, 10.5, 98),  (99, 0.5, 10.5, 99),
        # --- Top Left Area ---
    ...
    if DO_TRAIN:
        ...
        for ep in range(training_episodes):
            ...
            for pin_idx in range(len(pins)):
                ...
                while not done and steps < 100:
                    ...
                    # 🔥 [新增] 超時懲罰：打破苟且偷生的漏洞
                    # ====================================================
                    if not done and steps == 99:
                        reward -= 100.0  # 給予跟撞牆一樣重的懲罰
                        done = True      # 強制視為失敗並結束
                    # ====================================================
                    '''
                    ep_r += reward
            ...
            # =========== [修改] 判斷是否為最佳模型 (以成功率為主，分數為輔) ===========
            # 條件 1：成功佈線的 Pin 數量超越歷史紀錄
            # 條件 2：成功數量平手，但這回合的總分數 (線路更漂亮/懲罰更少) 更高
            if ep_succ > best_succ or (ep_succ == best_succ and ep_r > best_reward):
                best_succ = ep_succ
                best_reward = ep_r
                torch.save(dqn.state_dict(), BEST_MODEL_PATH)
                print(f"🔥 發現最佳模型！成功佈線數: {best_succ}/{len(pins)} (分數: {best_reward:.2f}) | 已保存至 {BEST_MODEL_PATH}")
            # ===============================================
            # ===============================================
            # [新增] 自動存檔機制
        ...
        # 👇 加上這兩行，確保接下來的 Demo 是用最高分的模型跑
        #print(f"載入最佳模型 ({BEST_MODEL_PATH}) 進行最終 Demo...")
    ...
    for demo_round in range(1):
        ...
        for pin_idx in range(len(pins)):
            ...
            if succ:
                ...
                # 👇 改成這樣！在最一開始就攔截 Direct Escape 給予 0.5
                if env.is_direct_done:
                    wire_lengths[pid] = 0.5
                else:
                    wire_lengths[pid] = len(env.current_path) - 0.5
                # 👆
        ...
        for pid in range(len(pins)):
            ...
            if net_id in env.commited_paths:
                ...
                # ==========================================
                wire_lengths[pid] = len(path_coords) - 0.5
                '''
                is_direct_escape = (len(path_lanes) > 0 and path_lanes[0] == -1)
                
                if is_direct_escape:
                    # 情況 A: Direct Escape (直接跳脫)
                    # 針腳直接連出邊界，沒有經過完整的 Tile 網格，依照 MMCF 權重計為 0.5
                    calc_length = 0.5
                else:
                    # 情況 B: 一般跳脫路徑
                    # 網格內部的移動權重為 1
                    # 考慮到 Pin 連接到第一個 Tile 中心，以及最後一個 Tile 連接出邊界的距離較短
                    # 整體線長扣除 0.5 的起始/邊界偏移量，以對齊 ILP 的 Cost Function
                    calc_length = len(path_coords) - 0.5
...
if __name__ == "__main__":
    ...
    raw_pins = [
        ...
        (16, 17.5, 15.5, 16), (17, 18.5, 15.5, 17), (18, 19.5, 15.5, 18),
        # --- Bottom Area ---
        (19, 13.5, 11.5, 19), (20, 19.5, 16.5, 20), (21, 19.5, 17.5, 21), (22, 19.5, 18.5, 22),
        (23, 18.5, 18.5, 23), (24, 17.5, 18.5, 24), (25, 19.5, 19.5, 25), (26, 18.5, 19.5, 26), 
        (27, 17.5, 19.5, 27), (28, 16.5, 17.5, 28), (29, 16.5, 19.5, 29), (30, 16.5, 18.5, 30),
        (31, 15.5, 18.5, 31), (32, 15.5, 17.5, 32), 
        (33, 14.5, 18.5, 33), (34, 14.5, 19.5, 34), 
        (35, 13.5, 17.5, 35), (36, 13.5, 18.5, 36), (37, 13.5, 19.5, 37), 
        (38, 12.5, 16.5, 38), (39, 12.5, 17.5, 39), (40, 12.5, 19.5, 40),  (41, 11.5, 16.5, 41), (42, 11.5, 17.5, 42),
        (43, 11.5, 18.5, 43), (44, 11.5, 19.5, 44), (45, 10.5, 15.5, 45), (46, 10.5, 16.5, 46), (47, 9.5, 17.5, 47), (48, 9.5, 18.5, 48),
        (49, 9.5, 19.5, 49), (50, 8.5, 14.5, 50), (51, 8.5, 15.5, 51), (52, 8.5, 18.5, 52),
        (53, 8.5, 19.5, 53), (54, 7.5, 14.5, 54), (55, 7.5, 18.5, 55), (56, 7.5, 19.5, 56),
        (57, 6.5, 17.5, 57), (58, 6.5, 18.5, 58), (59, 6.5, 19.5, 59), (60, 5.5, 15.5, 60),
        (61, 5.5, 18.5, 61), (62, 5.5, 16.5, 62), (63, 5.5, 19.5, 63), (64, 4.5, 18.5, 64),
        (65, 4.5, 17.5, 65), (66, 4.5, 16.5, 66), (67, 2.5, 17.5, 67), (68, 2.5, 18.5, 68),
        (69, 2.5, 19.5, 69), (70, 1.5, 19.5, 70), (71, 0.5, 19.5, 71), (72, 0.5, 18.5, 72),
        (73, 1.5, 17.5, 73), (74, 2.5, 16.5, 74), (75, 1.5, 16.5, 75), (76, 0.5, 16.5, 76),
        (77, 0.5, 15.5, 77), (78, 3.5, 14.5, 78), (79, 4.5, 14.5, 79), (80, 1.5, 14.5, 80),
        (81, 0.5, 14.5, 81), (82, 0.5, 13.5, 82), (83, 1.5, 13.5, 83), (84, 2.5, 13.5, 84),
        (85, 6.5, 12.5, 85), (86, 4.5, 12.5, 86), (87, 3.5, 12.5, 87), (88, 2.5, 12.5, 88),
        (89, 1.5, 12.5, 89), (90, 5.5, 11.5, 90), (91, 0.5, 11.5, 91), (92, 3.5, 10.5, 92),
        (93, 2.5, 10.5, 93), (94, 0.5, 10.5, 94),
        # --- Top Left Area ---
        (95, 1.5, 10.5, 95), (96, 1.5, 9.5, 96), (97, 0.5, 9.5, 97), (98, 4.5, 8.5, 98),
        (99, 3.5, 8.5, 99), (100, 2.5, 8.5, 100), (101, 0.5, 8.5, 101), (102, 4.5, 7.5, 102),
        (103, 3.5, 7.5, 103), (104, 2.5, 7.5, 104), (105, 4.5, 6.5, 105), (106, 2.5, 6.5, 106),
        (107, 1.5, 6.5, 107), (108, 0.5, 6.5, 108), (109, 8.5, 5.5, 109), (110, 3.5, 6.5, 110),
        (111, 4.5, 5.5, 111), (112, 2.5, 5.5, 112), (113, 0.5, 5.5, 113), (114, 5.5, 4.5, 114),
        (115, 3.5, 4.5, 115), (116, 2.5, 4.5, 116), (117, 1.5, 4.5, 117), (118, 0.5, 4.5, 118),
        (119, 3.5, 3.5, 119), (120, 1.5, 3.5, 120), (121, 0.5, 3.5, 121), (122, 0.5, 2.5, 122),
        (123, 2.5, 2.5, 123), (124, 0.5, 0.5, 124), (125, 1.5, 1.5, 125), (126, 2.5, 0.5, 126),
        (127, 2.5, 1.5, 127), (128, 3.5, 0.5, 128), (129, 3.5, 2.5, 129), (130, 4.5, 0.5, 130),
        (131, 4.5, 1.5, 131), (132, 4.5, 2.5, 132), (133, 5.5, 3.5, 133), (134, 5.5, 0.5, 134),
        (135, 5.5, 1.5, 135), (136, 6.5, 4.5, 136), (137, 6.5, 3.5, 137), (138, 6.5, 2.5, 138),
        (139, 6.5, 1.5, 139), (140, 7.5, 3.5, 140), (141, 7.5, 2.5, 141), (142, 7.5, 1.5, 142),
        (143, 7.5, 0.5, 143), (144, 8.5, 3.5, 144), (145, 8.5, 4.5, 145), (146, 8.5, 2.5, 146),
        (147, 8.5, 0.5, 147), (148, 9.5, 3.5, 148), (149, 9.5, 2.5, 149), (150, 9.5, 1.5, 150),
        (151, 9.5, 0.5, 151), (152, 10.5, 4.5, 152), (153, 10.5, 3.5, 153), (154, 10.5, 1.5, 154),
        (155, 10.5, 0.5, 155), (156, 12.5, 0.5, 156), (157, 11.5, 2.5, 157), (158, 11.5, 1.5, 158),
        (159, 12.5, 2.5, 159), (160, 12.5, 1.5, 160), (161, 14.5, 2.5, 161), (162, 14.5, 3.5, 162),
        (163, 15.5, 4.5, 163), (164, 15.5, 3.5, 164), (165, 17.5, 2.5, 165)
    ]
    ...
    raw_pins = [
        ...
        (152, 8.5, 0.5, 152), (153, 9.5, 3.5, 153), (154, 9.5, 2.5, 154), (155, 9.5, 1.5, 155),
        (156, 9.5, 0.5, 156), (157, 10.5, 4.5, 157), (158, 10.5, 3.5, 158), (159, 10.5, 1.5, 159),
        (160, 10.5, 0.5, 160), (161, 12.5, 0.5, 161), (162, 11.5, 2.5, 162), (163, 11.5, 1.5, 163),
        (164, 12.5, 2.5, 164), (165, 12.5, 1.5, 165), (166, 11.5, 3.5, 166), (167, 13.5, 3.5, 167),
        (168, 14.5, 4.5, 168), (169, 16.5, 0.5, 169), (170, 14.5, 3.5, 170)
    ]
    '''